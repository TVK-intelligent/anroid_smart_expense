...
@SpringBootTest
@Transactional
public class ReportServiceJdbcTest {
        ...
        @Test
        public void monthlyReport_totalsMatchTransactions_andFilteredByUser() {
                jdbcTemplate.update(
                                "INSERT INTO categories (user_id, name, type, icon) VALUES (NULL, 'Salary', 'INCOME', 'i')");
                jdbcTemplate.update(
                                "INSERT INTO categories (user_id, name, type, icon) VALUES (NULL, 'Food', 'EXPENSE', 'i')");

                Integer salaryCategoryId = jdbcTemplate.queryForObject(
                                "SELECT category_id FROM categories WHERE name='Salary'", Integer.class);
                ...
                assertThat(report.getIncomeExpenseByDay().get(0).getIncome())
                                .isEqualByComparingTo(new BigDecimal("1000.00"));
                assertThat(report.getIncomeExpenseByDay().get(0).getExpense())
                ...
                assertThat(report.getExpenseByCategory().get(0).getTotalSpent())
