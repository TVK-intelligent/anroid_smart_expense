...
public class MainActivity extends BaseActivity {
    ...
    private void loadCategoriesFromServer() {
        ...
        ApiClient.getApiService().getCategories(userId)
                .enqueue(new Callback<java.util.List<com.example.smartexpense.models.Category>>() {
                    @Override
                    public void onResponse(Call<java.util.List<com.example.smartexpense.models.Category>> call,
                            Response<java.util.List<com.example.smartexpense.models.Category>> response) {
                    ...
                    @Override
                    public void onFailure(Call<java.util.List<com.example.smartexpense.models.Category>> call,
                            Throwable t) {
                        // Fail silently
                    }
                });
